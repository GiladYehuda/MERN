...
const signup = async (req, res, next) => {
  ...
  if (existingUser) {
    const error = new HttpError(
      "user exist alreade, please login instead.",
      422
    );
    return next(error);
  }
...
const login = async (req, res, next) => {
  ...
  try {
    ...
    const error = new HttpError("Login in faild, please try again later.", 500);
    return next(error);
  }
  ...
  try {
    ...
    const error = new HttpError("Loggin in faild, please try again.", 500);
    return next(error);
  }
